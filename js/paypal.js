...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // [NUEVO] Función para redirigir a la página de pago rechazado
    function redirectToRejectedPage(reason = 'desconocido') {
        ...
        params.append('reason', reason); // Motivo del fallo

        window.location.href = `pago_rechazado.html?${params.toString()}`;
    }
        ...
        paypal.Buttons({
            ...
            onApprove: function(data, actions) {
                ...
                return actions.order.capture().then(function(details) {
                    ...
                    // [MODIFICADO] Se añade la redirección en caso de error en la captura
                    setTimeout(() => redirectToRejectedPage('error_captura'), 2500);
                });
            },
            onCancel: function(data) {
                showToastNotification('Has <strong>cancelado</strong> el proceso de pago.', 'info', 'Pago Cancelado');

                // [MODIFICADO] Se añade la redirección cuando el usuario cancela
                paymentModal.hide();
                setTimeout(() => redirectToRejectedPage('cancelado_por_usuario'), 2500);
            },
            onError: function(err) {
                ...
                // [MODIFICADO] Se añade la redirección en caso de un error general de PayPal
                setTimeout(() => redirectToRejectedPage('error_paypal'), 3000);
            }
         ...
         // SCRIPT PARA CARGAR DATOS DESDE localStorage (SIN CAMBIOS)
